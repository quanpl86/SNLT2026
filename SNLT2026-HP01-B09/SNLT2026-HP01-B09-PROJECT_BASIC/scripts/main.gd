...
func _on_checkpoint_activated(pos: Vector3) -> void:
	...
	print("[B09 Beta Main] Checkpoint updated respawn_position to: ", respawn_position)
...
func _on_collectible_collected(val: int) -> void:
	...
	if hud != null:
		hud.update_crystal_hud(crystal_count, target_count)
	print("[B09 Beta Main] Collected item! Total crystals: ", crystal_count, "/", target_count)
...
func _on_goal_reached() -> void:
	...
	if crystal_count >= target_count:
		...
		print("[B09 Beta Main] Reached goal, but not enough crystals! Needed: ", target_count, " Got: ", crystal_count)

func finish_game() -> void:
	is_finished = true
	if win_ui != null:
		win_ui.show_win()
	print("[B09 Beta Main] GAME FINISHED! BETA TEST VICTORY!")
...
func respawn_player() -> void:
	if player != null:
		...
		print("[B09 Beta Main] Respawned player at: ", respawn_position)
